...
export const newsItems: NewsType[] = [
  {
    id: 1,
    title: "Vntransp Logistics mở rộng đội xe vận tải đường bộ",
    excerpt:
      "Vntransp Logistics vừa đầu tư thêm 20 xe container mới nhằm nâng cao năng lực vận chuyển và đáp ứng nhu cầu ngày càng tăng của khách hàng.",
    content: `
      <p>Vntransp Logistics vừa đầu tư thêm 20 xe container mới nhằm nâng cao năng lực vận chuyển và đáp ứng nhu cầu ngày càng tăng của khách hàng. Đây là một phần trong chiến lược phát triển dài hạn của công ty, nhằm mở rộng quy mô và nâng cao chất lượng dịch vụ.</p>
      
      <p>Theo ông Nguyễn Văn A, Giám đốc Vntransp Logistics, việc đầu tư thêm 20 xe container mới sẽ giúp công ty tăng cường năng lực vận chuyển lên 30%, đáp ứng tốt hơn nhu cầu của khách hàng, đặc biệt là trong mùa cao điểm.</p>
      ...
      <p>Với việc mở rộng đội xe, Vntransp Logistics kỳ vọng sẽ tăng trưởng doanh thu 20% trong năm nay và tiếp tục khẳng định vị thế là một trong những công ty logistics hàng đầu tại Việt Nam.</p>
      
      <p>Vntransp Logistics hiện đang cung cấp các dịch vụ vận tải đường bộ, đường biển, đường sắt và dịch vụ kho bãi cho các khách hàng trong và ngoài nước. Công ty đã và đang là đối tác tin cậy của nhiều thương hiệu lớn như Toll, Gemadep, Taisun, Tân Á, Vigracera, Habeco và nhiều đối tác khác.</p>
    `,
    image: "/news-1.jpg",
    date: "15/03/2023",
    author: "Admin",
  ...
  },
  {
    ...
    excerpt:
      "Logistics xanh đang trở thành xu hướng tất yếu trong ngành vận tải toàn cầu. Vntransp Logistics đang từng bước áp dụng các giải pháp thân thiện với môi trường.",
    content: `
      <p>Logistics xanh đang trở thành xu hướng tất yếu trong ngành vận tải toàn cầu. Vntransp Logistics đang từng bước áp dụng các giải pháp thân thiện với môi trường, góp phần vào sự phát triển bền vững của ngành logistics Việt Nam.</p>
      ...
      <p>Tại Vntransp Logistics, công ty đã và đang triển khai nhiều giải pháp nhằm hướng tới logistics xanh. Cụ thể, công ty đã đầu tư vào đội xe tiêu chuẩn Euro 5, giúp giảm đáng kể lượng khí thải độc hại. Ngoài ra, công ty còn áp dụng các giải pháp tối ưu hóa lộ trình vận chuyển, giúp tiết kiệm nhiên liệu và giảm phát thải carbon.</p>
      
      <p>"Chúng tôi nhận thức rõ trách nhiệm của mình đối với môi trường và xã hội. Vì vậy, chúng tôi đang từng bước áp dụng các giải pháp logistics xanh, không chỉ để đáp ứng yêu cầu của khách hàng mà còn để góp phần vào sự phát triển bền vững của ngành logistics Việt Nam", ông Nguyễn Văn B, Phó Giám đốc Vntransp Logistics chia sẻ.</p>
      
      <p>Bên cạnh đó, Vntransp Logistics cũng đang nghiên cứu và thử nghiệm các phương tiện vận tải sử dụng năng lượng sạch như xe điện, xe hybrid. Công ty kỳ vọng trong tương lai gần sẽ có thể đưa vào sử dụng các phương tiện này, góp phần giảm đáng kể lượng khí thải độc hại.</p>
  ...
  {
    id: 3,
    title: "Vntransp Logistics ký kết hợp tác với đối tác Nhật Bản",
    excerpt:
      "Vntransp Logistics vừa ký kết thỏa thuận hợp tác chiến lược với Yamato Logistics - một trong những công ty logistics hàng đầu Nhật Bản.",
    content: `
      <p>Vntransp Logistics vừa ký kết thỏa thuận hợp tác chiến lược với Yamato Logistics - một trong những công ty logistics hàng đầu Nhật Bản. Đây là bước đi quan trọng trong chiến lược mở rộng thị trường và nâng cao chất lượng dịch vụ của Vntransp Logistics.</p>
      
      <p>Theo thỏa thuận, hai bên sẽ hợp tác trong các lĩnh vực vận tải đường biển, đường hàng không và dịch vụ kho bãi. Yamato Logistics sẽ hỗ trợ Vntransp Logistics trong việc áp dụng các tiêu chuẩn quản lý chất lượng của Nhật Bản, đồng thời hai bên sẽ cùng nhau phát triển các giải pháp logistics tích hợp cho khách hàng.</p>
      
      <p>Ông Tanaka Hiroshi, Giám đốc Yamato Logistics tại Việt Nam cho biết: "Chúng tôi rất ấn tượng với sự phát triển và tiềm năng của Vntransp Logistics. Thông qua hợp tác này, chúng tôi kỳ vọng sẽ mang đến cho khách hàng tại Việt Nam những dịch vụ logistics chất lượng cao theo tiêu chuẩn Nhật Bản."</p>
      
      <p>Về phía Vntransp Logistics, ông Nguyễn Văn C, Chủ tịch HĐQT chia sẻ: "Hợp tác với Yamato Logistics là một bước đi chiến lược trong quá trình phát triển của chúng tôi. Chúng tôi tin rằng, với kinh nghiệm và công nghệ của Yamato Logistics, cùng với sự am hiểu thị trường và mạng lưới rộng khắp của Vntransp Logistics, hai bên sẽ cùng nhau tạo ra những giá trị mới cho khách hàng."</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Để giúp doanh nghiệp tối ưu chi phí vận chuyển, Vntransp Logistics xin chia sẻ một số giải pháp sau:</p>
      ...
      <p>Việc thuê ngoài dịch vụ logistics cho các nhà cung cấp dịch vụ logistics bên thứ ba (3PL) như Vntransp Logistics có thể giúp doanh nghiệp tiết kiệm chi phí đáng kể. Các nhà cung cấp 3PL có mạng lưới rộng khắp, kinh nghiệm và công nghệ hiện đại, giúp tối ưu hóa quy trình logistics và giảm chi phí.</p>
      ...
      <p>Tại Vntransp Logistics, chúng tôi luôn sẵn sàng tư vấn và cung cấp các giải pháp tối ưu chi phí vận chuyển cho doanh nghiệp. Với kinh nghiệm nhiều năm trong ngành và mạng lưới rộng khắp, chúng tôi cam kết mang đến cho khách hàng dịch vụ chất lượng cao với chi phí hợp lý nhất.</p>
      
      <p>Để được tư vấn chi tiết, vui lòng liên hệ với chúng tôi qua hotline 0906286444 hoặc email daphuongthucvntransp@gmail.com.</p>
    `,
    image: "/news-4.jpg",
    date: "10/06/2023",
    author: "Admin",
  ...
  {
    id: 5,
    title: "Vntransp Logistics triển khai hệ thống quản lý vận tải TMS",
    excerpt:
      "Vntransp Logistics vừa triển khai hệ thống quản lý vận tải TMS hiện đại, giúp tối ưu hóa quy trình vận hành và nâng cao chất lượng dịch vụ.",
    content: `
      <p>Vntransp Logistics vừa chính thức triển khai hệ thống quản lý vận tải TMS (Transportation Management System) hiện đại, đánh dấu bước tiến quan trọng trong quá trình số hóa và tối ưu hóa quy trình vận hành của công ty.</p>
      
      <p>Hệ thống TMS được triển khai giúp Vntransp Logistics quản lý toàn diện quy trình vận tải từ lúc tiếp nhận đơn hàng, lập kế hoạch vận chuyển, điều phối phương tiện, theo dõi hành trình đến khi giao hàng và thanh toán. Hệ thống cũng tích hợp các tính năng như tối ưu hóa lộ trình, quản lý chi phí, báo cáo hiệu suất và quản lý tài xế.</p>
      
      <p>Ông Nguyễn Văn D, Giám đốc Công nghệ thông tin của Vntransp Logistics cho biết: "Việc triển khai hệ thống TMS là một phần trong chiến lược chuyển đổi số của công ty. Hệ thống giúp chúng tôi tối ưu hóa quy trình vận hành, giảm thiểu sai sót, tiết kiệm thời gian và chi phí, từ đó nâng cao chất lượng dịch vụ và sự hài lòng của khách hàng."</p>
      
      <p>Với hệ thống TMS, khách hàng của Vntransp Logistics có thể theo dõi trực tuyến vị trí và tình trạng hàng hóa theo thời gian thực, nhận thông báo tự động về tình trạng giao hàng và truy cập các báo cáo chi tiết về dịch vụ vận chuyển.</p>
      ...
      <p>Vntransp Logistics dự kiến sẽ tiếp tục đầu tư vào công nghệ trong thời gian tới, với mục tiêu trở thành công ty logistics hàng đầu về ứng dụng công nghệ tại Việt Nam.</p>
    `,
    image: "/news-5.jpg",
    date: "25/07/2023",
    author: "Admin",
  ...
  },
  {
    ...
    content: `
      ...
      <p>Tại Vntransp Logistics, chúng tôi đang từng bước ứng dụng các công nghệ 4.0 vào quy trình vận hành. Hệ thống TMS (Transportation Management System) mới triển khai là một ví dụ điển hình, giúp chúng tôi quản lý toàn diện quy trình vận tải và nâng cao chất lượng dịch vụ.</p>
